    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-gradient-to-b from-white to-green-50">
                ...
                {/* watering Techniques */}
                <section className="bg-white rounded-[1.5rem] p-10 shadow-md mt-20 space-y-12">
                    <div className="max-w-3xl mx-auto space-y-4 text-center">
                        <h2 className="text-3xl font-bold text-green-900 flex items-center font-serif justify-center gap-2">
                            Watering Techniques
                        </h2>
                        <p className="text-sm text-gray-600">Master watering with these simple and proven tips.</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto  ">
                        <div className="space-y-10 bg-green-900 p-10 rounded-bl-4xl rounded-tr-4xl shadow-sm h-80 mt-10">
                        ...
                        <div className="space-y-4 bg-green-900 p-10 rounded-br-4xl rounded-tl-4xl">
                    ...
                    <div className="max-w-5xl mx-auto space-y-8">
                        <h3 className="text-2xl font-semibold text-green-900 text-center">Signs of Watering Issues</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="bg-red-50 rounded-2xl overflow-hidden shadow-sm">
                                <img src="https://images.unsplash.com/photo-1597848212624-a19eb35e2651?auto=format&fit=crop&w=500&q=80"
                                    alt="Overwatered plant"
                                    className="w-full h-48 object-cover" />
                                <div className="p-5">
                                    <h4 className="text-red-600 font-semibold mb-2">Overwatering Symptoms</h4>
                            ...
                            <div className="bg-orange-50 rounded-2xl overflow-hidden shadow-sm">
                                <img src="https://images.unsplash.com/photo-1596638787647-904d822d751e?auto=format&fit=crop&w=500&q=80"
                                    alt="Underwatered plant"
                                    className="w-full h-48 object-cover" />
                                <div className="p-5">
                                    <h4 className="text-orange-600 font-semibold mb-2">Underwatering Symptoms</h4>
                                    <ul className="list-disc pl-5 text-sm text-gray-700 space-y-1">
